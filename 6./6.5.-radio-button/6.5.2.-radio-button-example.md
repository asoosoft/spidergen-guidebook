...
![](https://github.com/asoosoft/spidergen-guidebook/tree/eeac9656bff5b368e79bf9dad544cae218642e17/assets/rdo-ex-002.png)
...
* 라디오 버튼에 클릭 이벤트를 설정합니다.
  ...
  * > ```javascript
    ...
    > };
    > ```
* 프로젝트를 빌드 후 실행합니다. ![](https://github.com/asoosoft/spidergen-guidebook/tree/eeac9656bff5b368e79bf9dad544cae218642e17/assets/rdo-ex-004)
